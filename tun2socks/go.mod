...
require (
	...
	golang.org/x/mobile v0.0.0-20240604190613-2782386b8afd // Revert to known good version
	golang.org/x/tools v0.26.0 // indirect; Try newer version for Go 1.25 fix
)
