...
func NewWarpAPI(l *slog.Logger, anycastIPs, preferredFingerprint string) *WarpAPI {
	tlsDialer := Dialer{l: l, anycastIPs: anycastIPs, preferredFingerprint: preferredFingerprint}
