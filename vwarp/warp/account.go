...
func LoadOrCreateIdentity(l *slog.Logger, path, license, anycastIPs, preferredFingerprint string) (*Identity, error) {
	l = l.With("subsystem", "warp/account")

	warpAPI := NewWarpAPI(l, anycastIPs, preferredFingerprint)
